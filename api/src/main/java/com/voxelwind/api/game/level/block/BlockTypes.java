...
public class BlockTypes
{
	...
	public static final BlockType WOOD_PLANKS = IntBlock.builder ().name ("planks").id (5).maxStackSize (64).diggable (true).transparent (false).emitLight (0).filterLight (15).metadataClass (Wood.class).flammable (true).build ();
	...
	public static final BlockType WOOD = IntBlock.builder ().name ("log").id (17).maxStackSize (64).diggable (true).transparent (false).emitLight (0).filterLight (15).metadataClass (Log.class).flammable (true).build ();
	...
	public static final BlockType ACACIA_WOOD = IntBlock.builder ().name ("log2").id (162).maxStackSize (64).diggable (true).transparent (false).emitLight (0).filterLight (15).metadataClass (Log.class).flammable (true).build ();
